...
Unified agent class combining features from earlier versions.
"""
...
# Use simple remote handler for legacy commands
...
class UltimatePainNetworkAgent:
    ...
    def __init__(self, node_url: str = None, dashboard_port: int = None):
        ...
        self.remote_command_handler = RemoteCommandHandler()
        self.remote_command_handler.set_shutdown_callback(self.stop)
    ...
    def execute_remote_command(self, command_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return self.remote_command_handler.execute(cmd, **params)

    # Backwards compatibility with older API
    def handle_command(self, command: str, **params: Any) -> Dict[str, Any]:
        """Execute a remote command (legacy wrapper)."""
        result = self.remote_command_handler.execute(command, **params)
...
UltimateAgent = UltimatePainNetworkAgent
